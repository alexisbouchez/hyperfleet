...
async function main() {
  ...
  console.log("\nTo start a microVM, use the @hyperfleet/firecracker package.");
  console.log("\nExample:");
  console.log(`
...
const machine = new Machine({
  ...
  kernelArgs: "console=ttyS0 reboot=k panic=1 pci=off ip=172.16.0.2::172.16.0.1:255.255.255.0::eth0:off",
  vcpuCount: 1,
  memSizeMib: 128,
